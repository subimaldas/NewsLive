    ...
    return (
      <div>
        <BrowserRouter>
          ...
          <Routes>
            <Route exact path="/" element={<News setProgress={this.setProgress} key="technology" pageSize={this.pageSize} country="in" category="technology" />} />
            ...
            <Route exact path="/about" element={<News setProgress={this.setProgress} key="about" pageSize={this.pageSize} country="in" category="about" />} />
          </Routes>
        </BrowserRouter>
      </div>
    )
